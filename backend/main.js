...
if (process.env.NODE_ENV === 'development') app.use('/uploads', express.static(global.staticPath))
...
app.get('/gallery', (req, res) => pictureHandler.listAll(req, res, dbConnection))
